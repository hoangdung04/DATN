...
import { validateTour } from "../../middlewares/admin/validate.middleware.js";
...
router.post("/create", upload.fields([{ name: 'images', maxCount: 10 }]), uploadFields, checkPermission("tours_create"), validateTour, controller.createPost);
...
router.patch("/:id", upload.fields([{ name: "images", maxCount: 10 }]), uploadFields, checkPermission("tours_edit"), validateTour, controller.editPatch);
